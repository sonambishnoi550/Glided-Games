...
const Earn = () => {
    return (
        <div id='earn' className='bg-black -mt-1 lg:pb-[111px] md:pb-20 pb-16'>
            <div className="container">
                ...
                <p className='font-normal ff-poppins lg:text-xl text-base leading-custom-3xl text-white/70 max-w-[950px] mx-auto text-center'>Gilded World will be the first game released by Gilded Games. It is an MMORPG, browser based game that is unlike any other. We have taken inspiration from some of the most popular and successful MMORPG and RPG games and have boiled it down to the best online gameplay that people will actually want to play!</p>
