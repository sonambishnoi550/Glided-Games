      ...
      <div className="container">
        <div className='lg:flex xl:pt-[105px] items-center justify-between'>
          <div className='lg:pt-[101px] md:pt-10'>
            <h3 className='font-bold lg:text-5xl md:text-4xl text-3xl text-white leading-custom-xl pb-4 max-lg:text-center'> <span className='bg-gradient-to-tl from-purple to-sky bg-clip-text text-transparent'>NFT</span> Utility</h3>
